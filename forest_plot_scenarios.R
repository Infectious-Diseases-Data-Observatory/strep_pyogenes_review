...
gas_90 = read_excel("data/GAS_SR_Raw_50_90_NOS_formatted_20251106.xlsx") %>%
  filter(!is.na(mic90_1)) %>%
  clean_gas_data()

gas_nos_nintied = read_excel("data/GAS_SR_Raw_50_90_NOS_formatted_20251106.xlsx") %>%
...
gas_nos_raw = read_excel("data/GAS_SR_Raw_50_90_NOS_formatted_20251106.xlsx") %>%
  filter(!is.na(micnos_1))%>%
  clean_gas_data()
